...
## Components used within website
Sizing Utility - Gap used on the About Me section with:
"d-grid gap-3 p-2" and "bg-light border"

Carousel - used to display the pictures of Raleigh
begins with div denoted with id=carouselExampleIndicators

Sizing Utility - Auto Centering 
used on button as well as carousel 
denonted by class="mx-auto d-block" in the class 

Button component
class="btn btn-dark..." 

Alert used on click for the button 
